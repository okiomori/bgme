(function () {
  ...
  const enemyCatalog = {
    ...
    silkwing: {
      id: "silkwing",
      name: "Шёлкокрыл",
      role: "Налётчик крыльев",
      hp: 860,
      maxHp: 860,
      armor: 0,
      damage: 120,
      intent: "Заход в тыл",
      description: "Быстрая крылатая нечисть, которая обходит фронт и бьёт по задней линии.",
      form: "cantor",
    },
    redCantor: {
      id: "redCantor",
      ...
      armor: 2,
      damage: 200,
      intent: "Волновой резонанс по всей линии",
      description: "Аномальное существо событийной главы. Переплетает крылья и акустику в удар, который сотрясает всю очередь.",
      form: "cantor",
    },
    lowerGuardian: {
      id: "lowerGuardian",
      name: "Нижний хранитель",
      role: "Босс рейда",
      hp: 5200,
      maxHp: 5200,
      armor: 4,
      damage: 250,
      intent: "Молот эха в центральный строй",
      description: "Тяжёлый каменный страж глубокого рейда — бьёт сразу и без предупреждения.",
      form: "colossus",
    },
    stanchionElite: {
      id: "stanchionElite",
      name: "Стойка псалтыри",
      role: "Элитный страж",
      hp: 1960,
      maxHp: 1960,
      armor: 2,
      damage: 160,
      intent: "Усиление хранителя",
      description: "Поддерживает тяжёлого рейдового босса и удваивает его телеграф.",
      form: "colossus",
    },
    bridgeGuard: {
      id: "bridgeGuard",
      name: "Страж складного моста",
      role: "Минор-босс",
      hp: 1560,
      maxHp: 1560,
      armor: 1,
      damage: 130,
      intent: "Удар через пролёт",
      description: "Небольшой страж, который закрывает выход из сборного маршрута.",
      form: "cantor",
    },
    trialDummy: {
      id: "trialDummy",
      name: "Тренировочный страж",
      role: "Симуляция",
      hp: 720,
      maxHp: 720,
      armor: 0,
      damage: 80,
      intent: "Отработка телеграфа",
      description: "Безопасная симуляция стража святилища. Позволяет проверить связки навыков без риска.",
      form: "cantor",
    },
  };
